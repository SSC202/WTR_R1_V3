...
extern "C" {
#endif
#if (STM32F427xx || STM32F429xx) // 如果使用STM32F4系列
...
#if (USE_CAN2 == 1)
extern CAN_TxHeaderTypeDef hcan2_tx; // CAN1 发送处理单元句柄
extern CAN_RxHeaderTypeDef hcan2_rx; // CAN1 接受处理单元句柄
#endif
